...
struct Player_tF98BD09D3495D2FF1922E5D34866AEAC6AE2DF74  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// System.Boolean Player::powered
	bool ___powered_7;
	// UnityEngine.BoxCollider2D Player::boxCollider2D
	BoxCollider2D_tF860C7737FFB062CEC06577E0CD8364EEC1D4EDA* ___boxCollider2D_8;
	// UnityEngine.LayerMask Player::platformsLayerMask
	LayerMask_t97CB6BDADEDC3D6423C7BCFEA7F86DA2EC6241DB ___platformsLayerMask_9;
};
#ifdef __clang__
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Player_Start_mC31CF4F40DDEA35C5E39E8C43EC37284AE7C453D (Player_tF98BD09D3495D2FF1922E5D34866AEAC6AE2DF74* __this, const RuntimeMethod* method) 
{
	...
	Rigidbody2D_tBEBE9523CF4448544085AF46BF7E10AA499F320F* V_0 = NULL;
	{
		...
		__this->___boxCollider2D_8 = L_4;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___boxCollider2D_8), (void*)L_4);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Player_Update_m95E134A5EF1B5164EA281F61D7FA436F59BE3C9F (Player_tF98BD09D3495D2FF1922E5D34866AEAC6AE2DF74* __this, const RuntimeMethod* method) 
{
	...
	{
		bool L_1;
		L_1 = Player_IsGrounded_mFAB6EAC8B9B1F4274534F32D49D2FD58D1062C10(__this, NULL);
		if (!L_1)
		{
			goto IL_002c;
		}
	}
	{
		...
		Rigidbody2D_tBEBE9523CF4448544085AF46BF7E10AA499F320F* L_2 = __this->___rb2d_5;
...
IL_002c:
	{
		...
		bool L_6;
		L_6 = Input_GetKeyDown_mB237DEA6244132670D38990BAB77D813FBB028D2(((int32_t)113), NULL);
		if (!L_6)
		{
			goto IL_008a;
		}
	...
	}
	{
		...
		// powered = true;
		__this->___powered_7 = (bool)1;
		// Debug.Log(powered);
		bool L_11 = __this->___powered_7;
		bool L_12 = L_11;
...
IL_0070:
	...
	{
		// powered = false;
		__this->___powered_7 = (bool)0;
		// jumpPower = 5f;
		__this->___jumpPower_6 = (5.0f);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Player_IsGrounded_mFAB6EAC8B9B1F4274534F32D49D2FD58D1062C10 (Player_tF98BD09D3495D2FF1922E5D34866AEAC6AE2DF74* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		...
		BoxCollider2D_tF860C7737FFB062CEC06577E0CD8364EEC1D4EDA* L_0 = __this->___boxCollider2D_8;
		...
		BoxCollider2D_tF860C7737FFB062CEC06577E0CD8364EEC1D4EDA* L_4 = __this->___boxCollider2D_8;
		...
		LayerMask_t97CB6BDADEDC3D6423C7BCFEA7F86DA2EC6241DB L_9 = __this->___platformsLayerMask_9;
		int32_t L_10;
